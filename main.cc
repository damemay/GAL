...
int main(int argc, char* argv[]) {
...

    {
        ...
        auto model {std::make_unique<glp::Render_Model>("/home/mar/glTF-Sample-Models/2.0/Box/glTF/Box.gltf")};
    ...
    scene->set_callback([gl_shader, camera, pos] {
        glUseProgram(gl_shader);
        glUniformMatrix4fv(glGetUniformLocation(gl_shader, "view_projection"), 1, GL_FALSE, &camera->view_projection()[0][0]);
